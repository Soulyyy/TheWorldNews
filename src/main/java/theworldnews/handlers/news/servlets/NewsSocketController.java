...
public class NewsSocketController extends WebSocketServlet implements
		WebSocketCreator {
	...
	private static void publish(NewsSocketController controller,
	...
	public static NewsSocketController find(ServletContext context) {
		return (NewsSocketController) context
				.getAttribute(NewsSocketController.class.getName());
	}
}
